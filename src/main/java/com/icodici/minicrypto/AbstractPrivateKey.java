...
public abstract class AbstractPrivateKey extends AbstractAsymmetricKey implements Hashable {
     ...
     */
    public abstract byte[] sign(InputStream input, HashType hashType, byte[] salt) throws IOException;
     ...
     */
    public byte[] sign(byte[] data, HashType hashType, byte[] salt) {
        try {
     ...
     * @return digital signature
     */
    public byte[] sign(String data, HashType hashType, byte[] salt) {
