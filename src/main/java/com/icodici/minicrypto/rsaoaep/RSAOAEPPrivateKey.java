...
import com.icodici.minicrypto.AbstractPrivateKey;
...
public class RSAOAEPPrivateKey extends AbstractPrivateKey {
    ...
    void init(byte[] e, byte[] p, byte[] q, HashType oaepHashType, HashType mgf1HashType, SecureRandom rng) {
        ...
        state = new State(decryptor, privParameters, publicKey, oaepHashType, mgf1HashType, rng);
        resetDecryptor();
    }
     ...
     */
    @Override
    public byte[] sign(InputStream input, HashType hashType,  byte[] salt) throws IllegalStateException, IOException {
    ...
    public void updateFromHash(Map<String, Object> hash) throws Error {
        ...
        try {
            ...
            final String mgf1HashName = (String) (hash.containsKey("mgf1Hash") ? hash.get("mgf1Hash") : DEFAULT_MGF1_HASH.getAlgorithmName());
    ...
    @Override
    public byte[] pack() {
         final Map<String, Object> params = toHash();
