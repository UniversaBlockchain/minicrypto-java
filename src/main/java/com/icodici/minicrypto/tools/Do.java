...
package com.icodici.minicrypto.tools;
...
/**
 * Created by net.sergeych on 15/02/16.
 */
public class Do {
    ...
    public static byte[] decodeBase64(String base64) {
        ...
        if (n > 0) {
            ...
            while (n++ < 4)
                sb.append('=');
            return com.icodici.minicrypto.utils.Base64.decodeLines(sb.toString());
        } else
            return com.icodici.minicrypto.utils.Base64.decodeLines(baseStr);
    }
